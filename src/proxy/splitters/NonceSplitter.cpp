...
void NonceSplitter::printConnections()
{
    ...
    double efficiency = (double) m_stats.data().miners / (active * 256) * 100.0;
    ...
    if (Options::i()->colors()) {
        ...
        LOG_INFO("\x1B[01;32m* \x1B[01;37mminers   \x1B[0m" LABEL("active") "%s%" PRIu64 "\x1B[0m" LABEL("max") "\x1B[01;37m%" PRIu64 "\x1B[0m" LABEL("efficiency") "%s%3.1f%%",
                 m_stats.data().miners ? "\x1B[01;32m" : "\x1B[01;31m", m_stats.data().miners, m_stats.data().maxMiners, (efficiency > 80.0 ? "\x1B[01;32m" : (efficiency < 30.0 ? "\x1B[01;31m" : "\x1B[01;33m")), efficiency);
    }
    else {
        ...
        LOG_INFO("* miners:    active %" PRIu64 " max %" PRIu64 " efficiency %3.1f%%",
                 m_stats.data().miners, m_stats.data().maxMiners, efficiency);
    }
}
